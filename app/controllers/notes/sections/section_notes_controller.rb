    ...
    class SectionNotesController < AuthenticatedController
      ...
      def create
        ...
        if @section_note.valid? && @section_note.save
          redirect_to dashboard_url, notice: "Section note was successfully created."
        else
          render :new
        end
      end
      ...
      def update
        ...
        if @section_note.valid? && @section_note.save
          redirect_to dashboard_url, notice: "Section note was successfully updated."
        else
          render :edit
        end
      end
      ...
      def destroy
        ...
        redirect_to dashboard_url, notice: "Section note was successfully removed."
      end
